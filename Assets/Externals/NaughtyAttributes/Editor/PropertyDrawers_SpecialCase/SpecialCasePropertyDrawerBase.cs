...
namespace NaughtyAttributes.Editor
{
    ...
    {
        private static readonly Dictionary<Type, SpecialCasePropertyDrawerBase> s_DrawersByAttributeType;

        static SpecialCaseDrawerAttributeExtensions()
        {
            s_DrawersByAttributeType = new()
            {
        ...
        {
            if (s_DrawersByAttributeType.TryGetValue(attr.GetType(), out var drawer))
            {
                return drawer;
            }
            else
