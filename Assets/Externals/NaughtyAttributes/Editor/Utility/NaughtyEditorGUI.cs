...
namespace NaughtyAttributes.Editor
{
    public static class NaughtyEditorGUI
    {
        ...
        private static readonly GUIStyle s_buttonStyle = new(GUI.skin.button) { richText = true };
        ...
        public static void Button(UnityEngine.Object target, MethodInfo methodInfo)
        {
            ...
            if (methodInfo.GetParameters().All(p => p.IsOptional))
            {
                ...
                EnableWhen mode = buttonAttribute.SelectedEnableMode;
                buttonEnabled &=
                    mode == EnableWhen.Anytime ||
                    mode == EnableWhen.Editor && !Application.isPlaying ||
                    mode == EnableWhen.Playmode && Application.isPlaying;
