...
namespace LST.Player.Judge
{
    ...
    public sealed class InputHandle
    {
        ...
        public float Angle;
        public float GameAngle => Angle + GamePlayManager.MotionUpdater.CurrentRotation;
        public float Timing;
        ...
        public float GameFlickAngle => FlickAngle + GamePlayManager.MotionUpdater.CurrentRotation;
